...
2. **Python Basics**
   ...
   5. **Collection:** [tupple](./data/tuple.md), [list](./data/list.md), [set](./data/set.md), [dictionary](./data/dictionary.md), [Exercise-3](./data/exercise-3.md)
   6. **[Milestone Project](./data/milestone-project-1.md)**, [Solution](./project/cash_register.py)
